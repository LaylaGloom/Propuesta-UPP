...
<head>
	...
	<title>Propuesta Pagina UPP</title>
	...
	<link rel="stylesheet" type="text/css" href="vendor/twbs/bootstrap/docs/assets/css/ie10-viewport-bug-workaround.css">
...
<body>
	...
	<?php include ('front/menu.html') ?>
	<?php include ('front/sliderCalen.html') ?>
...
<!--<script src="vendor/twbs/bootstrap/js/carousel.js"></script>-->
